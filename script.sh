#!/bin/bash
export LASER="/home/fero/Work/uni/sentence_alignment/" # path with LASER embeddings -  needed for VECALIGN
...
python3 overlap.py -i "../texts/${fn}/${fn}_en.txt" -o "../texts/${fn}/overlaps_${fn}_en.txt" -n 10
echo "Creating overlap files for target..."
python3 overlap.py -i "../texts/${fn}/${fn}_sk.txt" -o "../texts/${fn}/overlaps_${fn}_sk.txt" -n 10
...
python3 vecalign.py -s ../texts/${fn}/${fn}_en.txt -t ../texts/${fn}/${fn}_sk.txt --src_embed ../texts/${fn}/overlaps_${fn}_en.txt ../texts/${fn}/overlaps_${fn}_en.emb --tgt_embed ../texts/${fn}/overlaps_${fn}_sk.txt ../texts/${fn}/overlaps_${fn}_sk.emb > ../texts/${fn}/vecaling_result_${fn}.txt
deactivate && cd ..
...
echo "\n***** BERT SENTENCE ALIGNER *****"
echo "Running Bertaling sentence aligner..."
cd bertalign
source "env/bin/activate"
python3 run.py ${fn}
deactivate && cd ..
...
echo "Running aligner_eval: evaluation of Bertaling sentence aligner..."
./evaluation/aligner_eval -s texts/${fn}/${fn}_bertaligned_en.txt -t texts/${fn}/${fn}_bertaligned_sk.txt --source_ref texts/${fn}/${fn}_ref_en.txt --target_ref texts/${fn}/${fn}_ref_sk.txt #--verbose
